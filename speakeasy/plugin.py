...
from speakeasy.factories import InventoryFactory, EthnicityFactory
...
def setup(sim: Neighborly, **kwargs: Any) -> None:
    ...
    sim.register_component(speakeasy.components.Ethnicity, factory=EthnicityFactory())
    ...
    load_prefab(_RESOURCES_DIR / "settlement.speakeasy.yaml")
